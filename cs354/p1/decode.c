...
/* (main function and try to read the cipher-file)
 *
 * (argc) (the total count of the argument without whitespace)
 * (*argv[]) (a pointer that point to address where stores the content in ciphertxt)
 * (return 0 if can not read the file)
 */
