...
int main(int argc, char *argv[]) {        
	...
	//fp is the pointer to the input file
	//size is the size that we scaned 
	get_dimensions(fp, &size);

	//Dynamically allocate a 2D array as per the retrieved dimensions
	//the array will always be created on the heap so that there is no null pointer
	//call the matrix array and allocated it 
	...
	//Create a structure and initialize its size and array fields appropriately
        //create the s1 and initialized the size and matrix
        Square s1 =  {size, matrix};
	...
	//&s1 is the address of structure op is the output file
