...
abstract class DataStructureADTTest<T extends DataStructureADT<String, String>> {
  ...
  // and removes
  @Test
  void test05_contains_returns_false_when_key_not_present() {
    dataStructureInstance.insert("1", "a");
    dataStructureInstance.insert("2", "b");
  ...
  @Test
  void test06_get_return_null_when_key_not_present() {
    dataStructureInstance.insert("1", "a");
    dataStructureInstance.insert("2", "b");
  ...
  @Test
  void test07_contains_return_false_when_insert_and_remove() {
    dataStructureInstance.insert("1", "a");
    dataStructureInstance.insert("2", "b");
  ...
  @Test
  void test08_get_return_null_when_insert_and_remove_one_key() {
    dataStructureInstance.insert("1", "a");
    dataStructureInstance.insert("2", "b");
    dataStructureInstance.remove("2");
    if (dataStructureInstance.get("2") != null) {
      fail(
  ...
  @Test
  void test_09_insert_null_size_is_empty() {
    try {
  ...
  @Test
  void test10_insert_2_remove_1_size_shouldbe_1() {
    dataStructureInstance.insert("1", "2");
    dataStructureInstance.insert("2", "b");
    dataStructureInstance.remove("2");
    if (dataStructureInstance.size() != 1) {
